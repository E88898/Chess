...
Pieces* Chessboard::createPiece(int row, int col, QPushButton* button) {
    ...
    if(row == 0 && col == 0) {
        ...
        return new Rook(Pieces::Color::Black,0,0);
    }
    if(row == 0 && col == 7) {
        button->setIcon(QIcon(":/Icons1/icons/black-rook.png"));
        return new Rook(Pieces::Color::Black, 0,7);
    }

    if(row == 7 && col == 0) {

        button->setIcon(QIcon(":/Icons1/icons/white-rook.png"));
        return new Rook(Pieces::Color::White, 7, 0);
    }
    if(row == 7 && col == 7) {
        button->setIcon(QIcon(":/Icons1/icons/white-rook.png"));
        return new Rook(Pieces::Color::White, 7, 7);
    }

    if(row == 0 && col == 1) {
        button->setIcon(QIcon(":/Icons1/icons/black-knight.png"));
        return new Knight(Pieces::Color::Black,0,1);
    }

    if(row == 0 && col == 6) {
        button->setIcon(QIcon(":/Icons1/icons/black-knight.png"));
        return new Knight(Pieces::Color::Black,0,6);
    }

    if(row == 7 && col == 1) {
        button->setIcon(QIcon(":/Icons1/icons/white-knight.png"));
        return new Knight(Pieces::Color::White,7,1);
    }
    if(row == 7 && col == 6) {
        button->setIcon(QIcon(":/Icons1/icons/white-knight.png"));
        return new Knight(Pieces::Color::White,7,6);
    }

    if(row == 0 && col == 2) {
        button->setIcon(QIcon(":/Icons1/icons/black-bishop.png"));
        return new Bishop(Pieces::Color::Black,0,2);
    }
    if(row == 0 && col == 5) {
        button->setIcon(QIcon(":/Icons1/icons/black-bishop.png"));
        return new Bishop(Pieces::Color::Black,0,5);
    }

    if(row == 7 && col == 2) {
        button->setIcon(QIcon(":/Icons1/icons/white-bishop.png"));
        return new Bishop(Pieces::Color::White,7,2);
    }
    if(row == 7 && col == 5) {
        button->setIcon(QIcon(":/Icons1/icons/white-bishop.png"));
        return new Bishop(Pieces::Color::White,7,5);
    }

    if(row == 0 && col == 3) {
        button->setIcon(QIcon(":/Icons1/icons/black-queen.png"));
        return new Queen(Pieces::Color::Black,0,3);
    }
    if(row == 7 && col == 3) {
        button->setIcon(QIcon(":/Icons1/icons/white-queen.png"));
        return new Queen(Pieces::Color::White,7,3);
    }

    if(row == 0 && col == 4) {
        button->setIcon(QIcon(":/Icons1/icons/black-king.png"));
        return new King(Pieces::Color::Black,0,4);
    }

    if(row == 7 && col == 4) {
        button->setIcon(QIcon(":/Icons1/icons/white-king.png"));
        return new King(Pieces::Color::White,7,4);
    }

    if(row == 1 ) {
        for(int j = 0; j < 8; ++j) {
            button->setIcon(QIcon(":/Icons1/icons/black-pawn.png"));
            return new Pawn(Pieces::Color::Black,row,j);
        }
    }
    ...
    if(row == 6 ) {
        for(int j = 0; j < 8; ++j) {
            ...
            return new Pawn(Pieces::Color::White,row,j);
        }
    }
